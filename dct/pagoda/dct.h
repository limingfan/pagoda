...
extern void DCT(float *fSrc, float *fDst, int Stride, int size, int thread, int block);
extern void computeDCT(float *fSrc, float *fDst, int Stride, int SIZE, int thread, int block);
extern void computeIDCT(float *fSrc, float *fDst, int Stride, int SIZE, int thread, int block);
#endif

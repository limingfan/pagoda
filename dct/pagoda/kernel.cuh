...
__device__ void d_computeDCT(float *fDst, float *fSrc, int Stride, int SIZE, int TDD_NUM, int BLOCK_SIZE, int baseTid)
{
...
__device__ void d_computeIDCT(float *fDst, float *fSrc, int Stride, int SIZE, int TDD_NUM, int BLOCK_SIZE, int baseTid)
{
...
__device__ void d_DCT(float *fSrc, float *fDst, int Stride, int size, int thread, int block, int baseTid){
    d_computeDCT(fSrc, fSrc, Stride, size, thread, block, baseTid);
    d_computeIDCT(fDst, fSrc, Stride, size, thread, block, baseTid);
}
